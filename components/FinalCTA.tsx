    ...
    <section className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-16 py-5 bg-gradient-to-r from-[#4F9C8F] to-[#3D8B7F] text-white rounded-full text-xl font-semibold font-['Inter'] shadow-2xl hover:shadow-[#4F9C8F]/40 transition-shadow cursor-pointer"
        >
          Explore Full Menu
        </motion.button>
        {/* Decorative Sparkle */}
